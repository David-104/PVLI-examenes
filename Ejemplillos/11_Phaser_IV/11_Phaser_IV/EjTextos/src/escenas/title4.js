...
export default class Title4 extends Phaser.Scene {
	...
	*/
	...
	continueCreate() {
		...
		this.textButton(this.cameras.main.centerX, 280, '4.-Local2 TTF Example', 'title4', true);
		this.textButton(this.cameras.main.centerX, 350, '5.-2º Local TTF Example', 'title5');
	}
